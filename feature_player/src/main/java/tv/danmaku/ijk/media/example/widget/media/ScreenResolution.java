...
public class ScreenResolution {
   ...
   * */
  public static Point getResolution(Context ctx){
   ...
   * */
  private static Point getRealResolutionOnOldDevice(Context ctx) {
    try{
  ...
  private static Point getRealResolution(Context ctx) {
    WindowManager wm = (WindowManager) ctx.getSystemService(Context.WINDOW_SERVICE);
    Display display = wm.getDefaultDisplay();
