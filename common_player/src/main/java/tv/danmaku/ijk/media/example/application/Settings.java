...
public class Settings {
    ...
    public static final int PV_PLAYER__KooExoMediaPlayer = 4;
    ...
    public void setPlayer(int val) {
        String key = mAppContext.getString(R.string.pref_key_player);
        mSharedPreferences.edit().putString(key, String.valueOf(val)).apply();
    }

    //自行添加的接口
    public void setUsingHevc(boolean enableHevc){
        mSharedPreferences.edit().putBoolean("pref.hevc", enableHevc).apply();
    }
    public boolean getUsingHevc(){
        return mSharedPreferences.getBoolean("pref.hevc", true);
    }
    ...
    public void setUsingMediaCodec(Boolean enableMediaCodec){
        String key = mAppContext.getString(R.string.pref_key_using_media_codec);
        mSharedPreferences.edit().putBoolean(key, enableMediaCodec).apply();
    }
    ...
    public boolean isYYP2PSettings() {

        String key = mAppContext.getString(R.string.pref_key_player_yyp2p);
        return mSharedPreferences.getBoolean(key, false);

    }

    public void setYYP2PSettings(boolean b) {
        String key = mAppContext.getString(R.string.pref_key_player_yyp2p);
